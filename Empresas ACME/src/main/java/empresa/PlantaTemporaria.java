...
public class PlantaTemporaria extends Empleado {
  ...
  public double getSalario() {
    return super.getHorasTrabajadas() * PlantaTemporaria.VALOR_HORA + super.getSalarioFamiliar(); //no se le pone this a VALOR_HORA porque es una variable de la clase y es static.
